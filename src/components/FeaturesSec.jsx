    ...
    <motion.section
      ...
      <motion.div 
        ...
        <motion.h2 
          ...
          className="text-3xl font-bold mb-4">How can we help your business?</motion.h2>
        <motion.p 
          ...
          features.map((feature, index) => (
            <motion.div 
              ...
              <motion.div 
                ...
                className="w-fit p-7 rounded-full mb-6 text-3xl" 
                style={{
              ...
              <motion.h3 
                ...
                className="text-2xl font-medium mb-3">{feature.title}</motion.h3>
              <motion.p 
                variants={fadeIn('up', 0.6 * (index + 1))}
                className="text-gray-500">{feature.description}</motion.p>
            </motion.div>
          ))
        }
      </motion.div>
