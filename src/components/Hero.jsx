...
function Hero() {
  return (
    <section className="container mx-auto flex flex-col md:flex-row justify-center items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        <form action="" className="flex gap-3 max-w-md">
          <input 
            type="email" 
            name="email" 
            id="email"
